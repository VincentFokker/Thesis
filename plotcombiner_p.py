...
if __name__ == "__main__":
    ...
    labels = ['pipeline_{}'.format(i) for i in range(10,55,5)]
    ...
    plt.legend()
    plt.savefig('figures/episode_reward_pipe_{}.png'.format(args.term))
    ...
    plt.legend()
    plt.savefig('figures/loss_pipe_{}.png'.format(args.term))
